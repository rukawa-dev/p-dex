...
async function main() {
  try {
    ...
    // 2. 구글 시트 데이터 가져오기
    console.log('🌐 구글 시트에서 ZA도감 목록을 가져오는 중...');
    ...
    const outputPath = 'pokemon-za.json';
    fs.writeFileSync(outputPath, JSON.stringify(zaPokemonList, null, 2));
    console.log(`\n💾 파일 저장 완료: ${outputPath}`);
